...
# 	podman run -v $PWD:/volume --rm -t clux/muslrust rustup target add x86_64-unknown-linux-musl; cargo install cargo-zigbuild; cargo build --target x86_64-unknown-linux-musl --release
